...
namespace BogatyrskayaZastava.Gameplay
{
    ...
    public class SynergySystem : MonoBehaviour
    {
        ...
        // BUG-013: private — внешний вызов в обход RefreshSynergies сломает diff-логику (события не будут опубликованы)
        private List<SynergyData> CheckActiveSynergies(List<TowerBase> placedTowers)
        {
